...
insert into trabajadores(name,trabajadorID,usuario,horaInicio,horaFin,horasTotales,peticionesID) values ('David','00002','Admin','2020-12-10 12:32','2020-12-10 19:50','8',null);
...
insert into trabajadores(name,trabajadorID,horaInicio,horaFin,horasTotales,peticionesID) values ('Carlos','00002','2021-01-10 00:01','2021-01-10 09:50','8',null);
insert into trabajadores(name,trabajadorID,horaInicio,horaFin,horasTotales,peticionesID) values ('kike','00004','2021-01-10 00:01',null,null,null);
...
insert into peticiones(peticionesID,fecha,categoria,texto,estado)values('00001','2021-01-13','vacaciones','me gustaría tomarme unas vacaciones','en espera');
...
select peticiones.peticionesID, peticiones.fecha, peticiones.categoria, peticiones.texto, peticiones.estado from peticiones inner join trabajadores where trabajadores.peticionesID=peticiones.peticionesID and trabajadores.usuario='Pruebas';

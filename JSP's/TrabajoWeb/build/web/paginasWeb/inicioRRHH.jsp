        ...
        %>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <a href="../operaciones/editar.jsp?trabajadorID=<%= rs.getString("trabajadorID")%>">Editar</a>
                    <a href="../operaciones/eliminar.jsp?trabajadorID=<%= rs.getString("trabajadorID")%>">Borrar</a>
                    </td>
                </tr>
                <%}%>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center">
                    <a href="../operaciones/editarEmpresa.jsp?empresaID=<%= rs.getString("empresaID")%>">Editar</a>
                    <a href="../operaciones/eliminarEmpresa.jsp?empresaID=<%= rs.getString("empresaID")%>">Borrar</a>
                    </td>
                </tr>
                <%}%>
            </table>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center"><%= rs.getString("empresaID")%></td>
                    <td class="text-center">
                    <a href="../operaciones/editarProyecto.jsp?proyectoID=<%= rs.getString("proyectoID")%>">Editar</a>
                    <a href="../operaciones/eliminarProyecto.jsp?proyectoID=<%= rs.getString("proyectoID")%>">Borrar</a>
                    </td>
                </tr>
                <%}%>
            </table>

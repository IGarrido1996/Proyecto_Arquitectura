        ...
        <div class="container">
            ...
            %>
                    <tr>
                        ...
                        <a href="../operaciones/editarPeticion.jsp?peticionesID=<%= rs.getString("peticionesID")%>" class="btn btn-warning btn-sm">Editar</a>
                        <a href="../operaciones/eliminarPeticion.jsp?peticionesID=<%= rs.getString("peticionesID")%>" class="btn btn-danger btn-sm">Borrar</a>
                        </td>
                    </tr>
                    <%}%>
                </table>

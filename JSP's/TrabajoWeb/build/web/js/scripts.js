...
const fechaInicio = document.getElementById('fechaInicioHidden');
const fechaFin = document.getElementById('fechaFinHidden');
const categoria = document.getElementById('categoriaHidden');

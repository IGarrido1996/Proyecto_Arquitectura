...
public final class Agregar_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <label>Código del trabajador:</label><br><br>\n");
      out.write("            <input type=\"text\" id=\"codigo\" class=\"casilla\" name=\"txttrabajadorID\" required min = \"1\" max = \"1000000\" pattern=\"[0-9]+\"><br><br>\n");
      ...
      out.write("            <label>Hora de inicio:</label><br><br>\n");
      out.write("            <input type=\"text\" id=\"horainicio\" class=\"casilla\" name=\"txthorainicio\" required maxlength=\"30\"><br><br>\n");
      ...
      out.write("</html>\n");
        ...
        String name,trabajadorID,usuario,horainicio;
        ...
        int trabajadorID2=1;
        while(identificadores.contains(trabajadorID2)){
            trabajadorID2++;
        }
        ...
        if(name!=null && trabajadorID!=null){
            java.util.Date date2 = dateFormat.parse(text);
            java.sql.Timestamp ts = new Timestamp(date2.getTime());
            ps=con.prepareStatement("insert into trabajadores(name,trabajadorID,usuario,horaInicio,horaFin,horasTotales) values ('"+name+"','"+trabajadorID2+"','"+usuario+"','"+ts+"',"+null+","+null+")");
            ps.executeUpdate();
